...
<label className="swap swap-rotate">
  ...
  <div className="">
    <a className="bg-black text-white px-3 py-2 rounded-md hovering:bg-slate-800 duration-300 cursor-pointer" onClick={()=> document.getElementById("my_modal_3").showModal()}>Login</a>
    <Login/>
    </div>
  </div>
</div>
